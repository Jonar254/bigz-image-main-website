...
const ProjectCard = ({ project, onHover, onLeave }) => {
  ...
  return (
    <Link
      href={`/documentaries/photography/${project.slug}`}
      ...
      >
        <div className="absolute inset-0">
          <img
            ...
            className={`absolute inset-0 h-full w-full object-cover transition-[transform,filter] duration-[1200ms] ease-out grayscale ${
...
const DocumentaryPhotographyHeader = () => {
...
const DocumentaryPhotography = () => {
  ...
  const rows = buildRows(documentaryPhotographyProjects);

  return (
    <div className="bg-white text-black">
      <DocumentaryPhotographyHeader />
      <PortfolioSection />
