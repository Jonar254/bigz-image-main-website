...
export function DocPhotographyHero() {
  ...
  return (
    ...
    >
      <Image
        src={encodeURI("/images/documentaries/community-webp/9B3A0434.webp")}
      ...
      >
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/85 font-light leading-relaxed max-w-2xl mx-auto">
          Authentic, high-quality imagery that brings your programmes to life for reports, campaigns, and digital
          platforms. We capture real moments with dignity and respect.
        </p>
      </div>
    </section>
  )
